...
https://www1.sap.sp.gov.br/conexao-familiar.html#top
  ...
  '15': async (chat, msg) => {
    await sendWithTyping(chat, msg.from, '🪪 Digite o CPF do(a) visitante, somente números:');
    awaitingCPF.add(msg.from);
  },
  '16': async (chat, msg) => {
    await sendWithTyping(chat, msg.from, '👤 Digite a matrícula do detento, somente números e sem o dígito:');
